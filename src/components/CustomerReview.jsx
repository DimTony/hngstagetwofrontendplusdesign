          ...
          {[1, 2, 3].map((user, index) => (
            ...
            >
              ...
              >
                ...
                >
                  My tote bag exceeded my expectations in every way. The design
                  matched my description perfectly, showcasing outstanding
                  quality and craftsmanship. The exceptional service ensured
                  that I received exactly what I envisioned. I am thoroughly
                  satisfied with the stylish and durable tote bag, which has
                  quickly become my go-to accessory for both everyday use and
                  special occasions.
                </Text>
              </VStack>
            </HStack>
